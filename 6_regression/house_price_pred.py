...
house_df_ohe.columns = house_df_ohe.columns.str.replace(' ', '_')
...
get_rmse_pred(preds)
"""
최종 혼합 모델의 RMSE: 0.10006075517615186
Ridge 모델의 RMSE: 0.10340697165289342
Lasso 모델의 RMSE: 0.10024171179335327
"""

xgb_reg = XGBRegressor(n_estimators=1000, learning_rate=0.05, colsample_bytree=0.5, subsample=0.8)
lgbm_reg = LGBMRegressor(n_estimators=1000, learning_rate=0.05, num_leaves=4, 
subsample=0.6, colsample_bytree=0.4, reg_lambda=10, n_jobs=-1, force_row_wise=True)
...
get_rmse_pred(preds)
"""
최종 혼합 모델의 RMSE: 0.10182829899113385
XGBM 모델의 RMSE: 0.10757317945441452
...
"""
스태킹 회귀 모델의 최종 RMSE 값은: 0.09703388089525994
"""